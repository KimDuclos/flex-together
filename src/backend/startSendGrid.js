...
if (!apiKey) console.error('It appears your API Key is missing. Check your dotenv setup.');

if (!fromEmail) console.error('It appears your Sender Email is missing. Check your dotenv setup.');

if (!testToEmail)
	console.log(
		'It appears your Test Receiver Email is missing. This is not an issue outside of testing. Check your dotenv setup.'
	);
