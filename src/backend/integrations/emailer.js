...
const Emailer = function() {
	...
	if (!this.apiKey) console.error('It appears your API Key is missing. Check your dotenv setup.');

	if (!this.fromEmail) console.error('It appears your Sender Email is missing. Check your dotenv setup.');
